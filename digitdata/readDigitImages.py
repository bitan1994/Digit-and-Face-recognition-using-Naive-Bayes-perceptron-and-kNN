...
flag=1
fname='/Users/shubhamsinha/Documents/data (1)/digitdata/validationimages'
...
#    temp.append(extractfeatures(digit))
    d=digit.flatten()
...
np.save('/Users/shubhamsinha/Documents/data (1)/digitdata/validation_images2.npy',temp)            
